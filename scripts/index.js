...
let countDown = new Date(`${config.birthdate} 18:00:00`).getTime();
x = setInterval(function() {
  ...
  let w = (c.width = window.innerWidth),
    ...
    hh = h / 2,
    opts = {
      strings: ['HAPPY', 'BIRTHDAY!', config.name,"Not just one Year older, But also one Year better"],
      charSize: 30,
      charSpacing: 35,
      lineHeight: 40,
